...
public class SupplierClass extends DatabaseConnect{
        ...
        public String adq="INSERT INTO suplieraccounttable(s_id,s_name,s_contact_no,s_add,s_food_type) VALUES(?,?,?,?,?)";
       // PreparedStatement insertm=(PreparedStatement) conn.prepareStatement(updatequery); 
...
//            insert.setString(5,s_food);
            ...
            super.insert.setString(1,s_id);
            super.insert.setString(2,s_name);
            super.insert.setString(3,s_contact);
            super.insert.setString(4,s_add);
            super.insert.setString(5,s_food);
    ...
    public void ad(PreparedStatement insertm){
